...
public class CryAlchemyPlugin extends Plugin {
	...
	private static final int ALCHEMY_ANIMATION_ID = 1162;
	...
	public void onGraphicChanged(GraphicChanged graphicChange)
	{
		...
		if(graphic == HIGH_LEVEL_ALCHEMY_GFX_ID)
		{
			actor.setAnimation(ALCHEMY_ANIMATION_ID);
			actor.setGraphic(HIGH_LEVEL_ALCHEMY_GFX_ID);
